...
// Copied from https://raw.githubusercontent.com/microsoft/vscode-python/main/src/client/apiTypes.ts
// Note: the jupyter related APIs were not included since they are not used in this extension.
